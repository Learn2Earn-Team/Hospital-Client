...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'appoinments',
                loadChildren: () => __webpack_require__.e(/*! import() | appoinments-appoinments-module */ "appoinments-appoinments-module").then(__webpack_require__.bind(null, /*! ../appoinments/appoinments.module */ "./src/app/pages/appoinments/appoinments.module.ts")).then(m => m.AppoinmentsPageModule)
            },
            {
                path: '',
