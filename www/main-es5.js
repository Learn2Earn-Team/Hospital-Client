  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var routes = [{
        ...
        loadChildren: function loadChildren() {
          ...
          "./src/app/pages/choose-location/choose-location.module.ts")).then(function (m) {
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | pages-location-map-location-map-module */
          "pages-location-map-location-map-module").then(__webpack_require__.bind(null,
          /*! ./pages/location-map/location-map.module */
          "./src/app/pages/location-map/location-map.module.ts")).then(function (m) {
            return m.LocationMapPageModule;
          });
        }
      }, {
        path: 'home',
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | pages-pharmacy-pharmacy-module */
          "pages-pharmacy-pharmacy-module").then(__webpack_require__.bind(null,
          /*! ./pages/pharmacy/pharmacy.module */
          "./src/app/pages/pharmacy/pharmacy.module.ts")).then(function (m) {
            return m.PharmacyPageModule;
          });
        }
      }, {
        path: 'cart',
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | pages-doctors-doctors-module */
          "pages-doctors-doctors-module").then(__webpack_require__.bind(null,
          /*! ./pages/doctors/doctors.module */
          "./src/app/pages/doctors/doctors.module.ts")).then(function (m) {
        ...
        loadChildren: function loadChildren() {
          ...
          "pages-set-reminder-set-reminder-module").then(__webpack_require__.bind(null,
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | pages-emergancy-emergancy-module */
          "pages-emergancy-emergancy-module").then(__webpack_require__.bind(null,
          /*! ./pages/emergancy/emergancy.module */
          "./src/app/pages/emergancy/emergancy.module.ts")).then(function (m) {
            return m.EmergancyPageModule;
          });
        }
      }, {
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | pages-current-location-current-location-module */
          "pages-current-location-current-location-module").then(__webpack_require__.bind(null,
          /*! ./pages/current-location/current-location.module */
          "./src/app/pages/current-location/current-location.module.ts")).then(function (m) {
            return m.CurrentLocationPageModule;
          });
        }
      }, {
        path: 'appoinments',
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | pages-appoinments-appoinments-module */
          "appoinments-appoinments-module").then(__webpack_require__.bind(null,
          /*! ./pages/appoinments/appoinments.module */
        ...
        loadChildren: function loadChildren() {
          ...
          "pages-chat-detail-chat-detail-module").then(__webpack_require__.bind(null,
          /*! ./pages/chat-detail/chat-detail.module */
          "./src/app/pages/chat-detail/chat-detail.module.ts")).then(function (m) {
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | pages-doctor-list-doctor-list-module */
          "pages-doctor-list-doctor-list-module").then(__webpack_require__.bind(null,
          /*! ./pages/doctor-list/doctor-list.module */
          "./src/app/pages/doctor-list/doctor-list.module.ts")).then(function (m) {
            return m.DoctorListPageModule;
          });
        }
      }, {
        path: 'doctor-detail',
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | pages-doctor-detail-doctor-detail-module */
          "pages-doctor-detail-doctor-detail-module").then(__webpack_require__.bind(null,
          /*! ./pages/doctor-detail/doctor-detail.module */
          "./src/app/pages/doctor-detail/doctor-detail.module.ts")).then(function (m) {
            return m.DoctorDetailPageModule;
          });
        }
      }, {
        path: 'get-ambulance',
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | pages-get-ambulance-get-ambulance-module */
          "pages-get-ambulance-get-ambulance-module").then(__webpack_require__.bind(null,
          /*! ./pages/get-ambulance/get-ambulance.module */
          "./src/app/pages/get-ambulance/get-ambulance.module.ts")).then(function (m) {
            return m.GetAmbulancePageModule;
          });
        }
      }, {
        path: 'booking',
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | pages-payment2-payment2-module */
          "pages-payment2-payment2-module").then(__webpack_require__.bind(null,
          /*! ./pages/payment2/payment2.module */
          "./src/app/pages/payment2/payment2.module.ts")).then(function (m) {
            return m.Payment2PageModule;
          });
        }
      }, {
        path: 'my-orders',
        loadChildren: function loadChildren() {
          ...
          "pages-my-orders-my-orders-module").then(__webpack_require__.bind(null,
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | pages-upload-document-upload-document-module */
          [__webpack_require__.e("common"), __webpack_require__.e("pages-upload-document-upload-document-module")]).then(__webpack_require__.bind(null,
          /*! ./pages/upload-document/upload-document.module */
          "./src/app/pages/upload-document/upload-document.module.ts")).then(function (m) {
            return m.UploadDocumentPageModule;
          });
        }
      }, {
        path: 'doc-list',
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | pages-doc-list-doc-list-module */
          "pages-doc-list-doc-list-module").then(__webpack_require__.bind(null,
          /*! ./pages/doc-list/doc-list.module */
          "./src/app/pages/doc-list/doc-list.module.ts")).then(function (m) {
            return m.DocListPageModule;
          });
        }
      }];
    ...
    function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_7__["AppRoutingModule"], ng_otp_input__WEBPACK_IMPORTED_MODULE_9__["NgOtpInputModule"], ionic2_calendar__WEBPACK_IMPORTED_MODULE_10__["NgCalendarModule"]],
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! E:\Ionic Projects\ionic-5-template-bundle-ionic-5-themes-bundles-ionic-5-templates-with-10-apps\App_source_code\Apps_code\Medico_medical\src\main.ts */
      "./src/main.ts");
      /***/
    }
  }, [[0, "runtime", "vendor"]]]);
